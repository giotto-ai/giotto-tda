...
template <typename CubicalComplexOptions =
              Gudhi::Cubical_complex::Bitmap_cubical_complex_base<double>>
class Cubical_complex_interface
    : public Gudhi::Cubical_complex::Bitmap_cubical_complex<
          CubicalComplexOptions> {
 public:
  Cubical_complex_interface(const std::vector<unsigned>& dimensions,
                            const std::vector<double>& top_dimensional_cells)
      : Gudhi::cubical_complex::Bitmap_cubical_complex<CubicalComplexOptions>(
