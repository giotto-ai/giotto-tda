...
class MapperPipeline(Pipeline):
    ...
    The convenience methods :meth:`get_mapper_params` and
    :meth:`set_mapper_params` allow for simple access to the parameters
    involved in the definition of a Mapper pipeline, without the need to
    interface with the nested structure of the Pipeline objects generated
    by :func:`make_mapper_pipeline`.
