"""The module :mod:`glearn.pipeline` extends scikit-learn's module by defining
...
class Pipeline(pipeline.Pipeline):
    ...
    --------
    >>> import numpy as np
    >>> import glearn.time_series as ts
    >>> import glearn.homology as hl
    >>> import glearn.diagrams as diag
    >>> from glearn.pipeline import Pipeline
