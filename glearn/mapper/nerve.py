...
class Nerve(BaseEstimator, TransformerMixin):
    ...
    :class:`glearn.mapper.pipeline.MapperPipeline` objects created
    by :func:`glearn.mapper.make_mapper_pipeline`. It is not intended for
    direct use.
    ...
    def fit(self, X, y=None):
        ...
        X : list of list of tuple
            ...
            :class:`glearn.mapper.MapperPipeline`, this is the output of the
            clustering step.
