...
class MapperPipeline(Pipeline):
    ...
    pipelines generated by :func:`glearn.mapper.pipeline.make_mapper_pipeline`.
    ...
    generated by :func:`glearn.mapper.pipeline.make_mapper_pipeline`. The
    ...
    >>> from glearn.mapper import make_mapper_pipeline, CubicalCover
...
def make_mapper_pipeline(scaler=None,
    ...
    cover : object or None, optional, default: ``None``
        ...
        (:meth:`glearn.mapper.CubicalCover`) with its default parameters.
    ...
    Returns
    -------
    mapper_pipeline : :class:`glearn.mapper.pipeline.MapperPipeline` object
        Output Mapper pipeline.

    Examples
    --------
    >>> # Example of basic usage with default parameters
    >>> from glearn.mapper import make_mapper_pipeline
    >>> mapper = make_mapper_pipeline()
    >>> print(mapper.__class__)
    <class 'glearn.mapper.pipeline.MapperPipeline'>
    ...
    <class 'glearn.mapper.cover.CubicalCover'>
    ...
    >>> # glearn.mapper.filter, and a clusterer from glearn.mapper.cluster
    >>> from sklearn.preprocessing import MinMaxScaler
    >>> from glearn.mapper import Projection, FirstHistogramGap
    >>> scaler = MinMaxScaler()
    ...
    >>> import numpy as np
    >>> from glearn.mapper import OneDimensionalCover
    ...
    See also
    --------
    MapperPipeline, glearn.mapper.utils.decorators.method_to_transform
