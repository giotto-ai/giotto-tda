...
images_2D_height = np.array(
    [[[0., 0.70710678, 1.41421356, 2.12132034],
     ...
     [[0., 0.70710678, 3.53553391, 3.53553391],
      [0.70710678, 1.41421356, 3.53553391, 3.53553391],
    [1.41421356, 2.12132034, 3.53553391, 3.53553391]],
...
def test_height_transform(direction, images, expected):
    ...
    print(height.fit_transform(images))
