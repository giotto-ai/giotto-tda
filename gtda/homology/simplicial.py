...
class SparseRipsPersistence(BaseEstimator, TransformerMixin):
    ...
    def plot(X, sample=0, **layout):
        """Plot a single persistence diagram in the collection.
        ...
        sample : int, optional, default: ``0``
            Number of the sample to be plotted.

        layout : dict, optional
            Dict of string/value properties that will be passed to the
            :mod:`plotly.graph_objs.Layout` constructor.
            Supported dict properties:
                angularaxis
                    plotly.graph_objects.layout.AngularAxis instance or dict
