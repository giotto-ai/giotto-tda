.. note::
    ...
    Click :ref:`here <sphx_glr_download_gallery_plotting.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_plotting.py:
...
.. _sphx_glr_download_gallery_plotting.py:
