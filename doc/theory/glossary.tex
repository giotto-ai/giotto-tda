...
\begin{document}
	...
	A \textit{persistence landscape} isa set $\{\lambda_k\}_{k \in \mathbb N}$ of functions
	\begin{equation*}
	\lambda : \mathbb R \to \overline{\mathbb R}
	\end{equation*}
	where $\lambda_k$ is referred to as the \textit{$k$-layer of the persistence landscape}.
	...
	The \textit{$p$-norm} of a \hyperref[persistence landscape]{persistence landscape} $\lambda = \{\lambda_k\}_{k \in \mathbb N}$ is defined to be
