"""The module :mod:`giottolearn.pipeline` extends scikit-learn's module by
defining pipelines that include TransformerResamplers."""
# License: GNU AGPLv3
...
class Pipeline(pipeline.Pipeline):
    ...
    --------
    >>> import numpy as np
    >>> import giottolearn.time_series as ts
    >>> import giottolearn.homology as hl
    >>> import giottolearn.diagrams as diag
    >>> from giottolearn.pipeline import Pipeline
