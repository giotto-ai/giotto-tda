...
class Nerve(BaseEstimator, TransformerMixin):
    ...
    :class:`giottolearn.mapper.pipeline.MapperPipeline` objects created
    by :func:`giottolearn.mapper.make_mapper_pipeline`. It is not intended for
    direct use.
    ...
    def fit(self, X, y=None):
        ...
        X : list of list of tuple
            ...
            :class:`giottolearn.mapper.MapperPipeline`, this is the output of
            the clustering step.
