...
class MapperPipeline(Pipeline):
    ...
    pipelines generated by :func:`giotto.mapper.pipeline.make_mapper_pipeline`.
    ...
    generated by :func:`giotto.mapper.pipeline.make_mapper_pipeline`. The
    ...
    >>> from giottolearn.mapper import make_mapper_pipeline, CubicalCover
...
def make_mapper_pipeline(scaler=None,
    ...
    Returns
    -------
    mapper_pipeline : :class:`giotto.mapper.pipeline.MapperPipeline` object
        Output Mapper pipeline.

    Examples
    --------
    >>> # Example of basic usage with default parameters
    >>> from giottolearn.mapper import make_mapper_pipeline
    ...
    >>> from giottolearn.mapper import Projection, FirstHistogramGap
    >>> scaler = MinMaxScaler()
    ...
    >>> import numpy as np
    >>> from giottolearn.mapper import OneDimensionalCover
